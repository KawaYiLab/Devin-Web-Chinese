 ...
 *
 * 添加新词条：直接在 DICTIONARY 对象中添加 "English": "中文" 键值对即可。
 * 添加正则规则：在 REGEX_RULES 数组中添加 { pattern: /正则/, replacement: "替换文本" }。
 */
...
const DICTIONARY = {
  ...
  "Migration": "迁移",
  "Configuration": "配置",
  "Organization blueprint": "组织蓝图",
  "Not set. Add one to share setup across this org": "未设置。添加一个以在此组织中共享设置",
  "Added repositories are cloned and set up in the order shown during snapshot builds. Drag to reorder": "已添加的仓库将按显示顺序在快照构建期间克隆和设置。拖拽以重新排序",
  "No repositories added": "未添加仓库",
  "Add repositories to configure per-repo setup instructions.": "添加仓库以配置每个仓库的设置指令。",
  ...
  // ========== 主页描述文案 ==========
  "Devin is the AI software engineer built for teams. Devin autonomously plans, codes, tests, and ships.": "Devin 是专为团队打造的 AI 软件工程师。Devin 自主规划、编码、测试和交付。",
  "Configure how Devin's environment is set up for your organization.": "配置 Devin 环境在您组织中的设置方式。",
  "Devin recalls relevant knowledge automatically during sessions. Learn more in our": "Devin 在会话期间自动回忆相关知识。在我们的文档中了解更多",
  "Reference a secret with a dollar sign, e.g.": "使用美元符号引用密钥，例如",
  ...
  "Your unique organization identifier for API usage": "用于 API 的唯一组织标识符",
  ...
  "Share data for training": "共享数据用于训练",
  ...
  "User ID": "用户 ID",
  "Your unique user identifier for API usage": "用于 API 的唯一用户标识符",
  ...
  "Co-authored (Devin + you)": "共同署名（Devin 与你）",
  "Co-authored (you + Devin)": "联合署名（你 + Devin）",
  "You only": "仅自己署名",
  ...
  "Open pull requests as drafts": "将拉取请求作为草稿打开",
  "Devin will always create pull requests as drafts": "Devin 将始终以草稿形式创建拉取请求",
  "Pre-approve testing": "预批准测试",
  "Devin will test the app without asking for approval first": "Devin 将无需事先征求批准即测试应用",
  ...
  "Review trigger": "审查触发",
  "When will Devin review any of my new or updated pull requests": "Devin 何时审查我的新建或更新的拉取请求",
  ...
  "Computer use": "计算机使用",
  "Devin uses full computer use tools (mouse, keyboard, screen). When disabled, Devin uses legacy browser tools instead.": "Devin 使用完整的计算机操作工具（鼠标、键盘、屏幕）。禁用时，Devin 将使用旧版浏览器工具。",
  "Session agents": "会话代理",
  "Choose which agents are used in sessions": "选择会话中使用的代理",
  "Default agent": "默认代理",
  "Default agent for all new sessions in your organization": "组织中所有新会话的默认代理",
  "Default platform": "默认平台",
  "Default platform for all new sessions in your organization": "组织中所有新会话的默认平台",
  "Commands": "命令",
  "Custom commands for the chat input. Type / to see available commands": "聊天输入的自定义命令。输入 / 查看可用命令",
  "Manage commands": "管理命令",
  "Add Command": "添加命令",
  "Request implementation of a change": "请求实现一个更改",
  "Create a detailed plan before implementation": "在实现前创建详细计划",
  "Review the changes for correctness and completeness": "审查更改的正确性和完整性",
  "Test the changes thoroughly": "彻底测试更改",
  ...
  "Pull requests": "拉取请求",
  "How Devin creates, manages, and responds to pull requests": "Devin 如何创建、管理和响应拉取请求",
  ...
  // ========== Devin 审查设置页面 ==========
  "Organization preferences and settings for Devin Review": "Devin 审查的组织偏好和设置",
  "PR descriptions": "PR 描述",
  "Adjust how Devin Review edits pull request descriptions": "调整 Devin 审查编辑拉取请求描述的方式",
  "Add \"Devin Review\" link in PR description": "在 PR 描述中添加\"Devin 审查\"链接",
  "Includes a link to Devin Review in the pull request description": "在拉取请求描述中包含 Devin 审查的链接",
  "Security scan": "安全扫描",
  ...
  "Analyses from Devin Review can be posted as comments to git providers": "Devin 审查的分析结果可以作为评论发布到 Git 服务",
  "Bugs": "缺陷",
  ...
  "Limit how much Devin Review spends on automatic reviews": "限制 Devin 审查在自动审查上的花费",
  ...
  "Add context to help Devin find bugs": "添加上下文以帮助 Devin 发现缺陷",
  "Common file patterns": "常用文件模式",
  "are read automatically": "会被自动读取",
  "Prioritized by proximity to changed files.": "按与更改文件的接近程度排序。",
  "Add repo": "添加仓库",
  ...
  "Explore plans": "查看方案",
  "Ask Devin to build features, fix bugs, or work on your code": "让 Devin 构建功能、修复缺陷或处理您的代码",
  ...
  "Validate in Devin Review": "在 Devin 审查中验证",
  ...
  "Triage Bug Reports on Slack": "在 Slack 上分类 Bug 报告",
  "CI Failure Fixer": "CI 失败修复器",
  "Triage Devins": "分类 Devin",
  "Create automation": "创建自动化",
  "No automations yet": "暂无自动化",

  // ========== 模型选择弹窗 ==========
  "Fast and good at long-horizon planning": "快速且擅长长期规划",
  "Ultra": "Ultra",
  "Our most powerful and hardest thinking agent, significantly more expensive": "我们最强大的深度思考代理，费用显著增加",
  "Fast Mode": "快速模式",
  "2.5x faster, 2x more expensive, same intelligence": "速度快 2.5 倍，费用增加 2 倍，智能不变",
  "Tuned for smaller, well-defined tasks. 60% cheaper": "适用于规模较小、目标明确的任务，使用成本比标准版本低 60%。",
  ...
  // ========== Automations 描述 ==========
  "Monitors a Slack channel for bug reports \u2014 when one comes in, Devin triages it, investigates the root cause and replies in the thread with findings": "监控 Slack 频道的 Bug 报告 \u2014 当收到报告时，Devin 分类问题、调查根因并在回复线程中提供发现",
  "Automatically fix failing CI checks on non-Devin PRs. Devin reads the build logs, identifies the root cause, pushes a fix, and verifies it passes.": "自动修复非 Devin PR 上失败的 CI 检查。Devin 读取构建日志、识别根因、推送修复并验证通过。",
  "When someone comments /devin on a GitHub issue, Devin reads the issue, investigates the codebase, and opens a fix PR \u2014 turning any issue into an actionable code change.": "当有人在 GitHub Issue 上评论 /devin 时，Devin 读取 Issue、调查代码库并创建修复 PR \u2014 将任何 Issue 转为可执行的代码变更。",
  ...
  "Connect external services and tools to your organization in Devin.": "在 Devin 中连接外部服务和工具到您的组织。",
  "MCP servers": "MCP 服务器",
  "Git providers": "Git 提供商",
  "Try Devin on your codebase": "在您的代码库中试用 Devin",
  "Communication": "通讯",
  "Tag @Devin in your team workspaces": "在团队工作区中 @Devin",
  "Task management": "任务管理",
  "Turn tickets into pull requests": "将工单转为拉取请求",
  ...
  "Generation": "生成",
  "Configure how DeepWiki indexes your repository source code for Wiki and Ask Devin": "配置 DeepWiki 如何索引您的仓库源代码用于 Wiki 和 Ask Devin",
  "Effort": "工作量",
  "Higher effort generates better quality at greater cost": "更高的工作量产生更好的质量但成本更高",
  ...
  // ========== 环境设置页面 ==========
  "Environment setup for Devin sessions": "Devin 会话的环境设置",
  "Blueprint": "蓝图",
  "Build status": "构建状态",
  "Last built": "上次构建",
  ...
  "Create playbook from session": "从会话创建剧本",
  ...
  "Integrate Devin with GitHub": "将 Devin 与 GitHub 集成",
  "Add connection": "添加连接",
  "Support": "支持",
  ...
  "Let Devin build features, fix bugs, or handle your code": "让 Devin 构建功能、修复缺陷或处理您的代码",
  ...
  "Wait for CI": "等待 CI",
  "Make changes": "进行更改",
  "Make frontend changes": "进行前端更改",
  "Make backend changes": "进行后端更改",
  "Investigate": "调查",
  "Implement": "实现",
  "Fix": "修复",
  "Research": "研究",
...
const REGEX_RULES = [
  ...
  // 变更数量
  { pattern: /^(\d+)\s+changes?$/i, replacement: "$1 个更改" },
  // 通知数量
  ...
  // "Powered by X" → "由 X 驱动"
  { pattern: /^Powered by\s+(.+)$/i, replacement: "由 $1 驱动" },
  ...
  { pattern: /^Viewed pull request #(\d+) in (.+)$/i, replacement: "查看了 $2 中的拉取请求 #$1" },
  ...
  { pattern: /^Make frontend changes to (.+)$/i, replacement: "进行前端更改以$1" },
  // "Make backend changes to X" → "进行后端更改以 X"
  { pattern: /^Make backend changes to (.+)$/i, replacement: "进行后端更改以$1" },
